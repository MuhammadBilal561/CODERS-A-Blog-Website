...
const ScImageSlider = class {
  ...
  render() {
    ...
    return (index.h("div", { class: { 'image-slider': true, 'image-slider--is-fixed-height': !this.autoHeight }, part: "base" }, index.h("div", { class: "swiper", ref: el => (this.swiperContainerRef = el) }, index.h("div", { class: "swiper-wrapper" }, (this.imagesData || []).map(({ src, alt, srcset, width, height, sizes, title }, index$1) => (index.h("div", { key: index$1, class: "swiper-slide image-slider__slider" }, index.h("div", { class: "swiper-slide-img" }, index.h("img", { src: src, alt: alt, srcset: srcset, width: width, height: height, sizes: sizes, loading: index$1 > 0 ? 'lazy' : 'eager', ...(title ? { title } : {}) }))))))), this.hasThumbnails && (index.h("div", { class: { 'image-slider__thumbs': true, 'image-slider__thumbs--has-navigation': this.images.length > 5 } }, index.h("button", { disabled: (_b = this.thumbsSwiper) === null || _b === void 0 ? void 0 : _b.isBeginning, class: "image-slider__navigation image-slider--is-prev", ref: el => (this.previous = el) }, index.h("sc-visually-hidden", null, wp.i18n.__('Go to previous product slide.', 'surecart')), index.h("sc-icon", { name: "chevron-left", "aria-hidden": "true", "tab-index": "0" })), index.h("div", { class: "swiper", ref: el => (this.swiperThumbsRef = el) }, index.h("div", { class: "swiper-wrapper", role: "radiogroup", "aria-label": wp.i18n.sprintf(wp.i18n.__('Products slide options section. There are %d options present.', 'surecart'), (thumbnails === null || thumbnails === void 0 ? void 0 : thumbnails.length) || 0) }, (thumbnails || []).map(({ src, alt, srcset, width, height, sizes, title }, index$1) => (index.h("button", { class: { 'swiper-slide': true, 'image-slider__thumb': true, 'image-slider__thumb--is-active': this.currentSliderIndex === index$1 }, onClick: () => { var _a, _b; return (_b = (_a = this.swiper) === null || _a === void 0 ? void 0 : _a.slideTo) === null || _b === void 0 ? void 0 : _b.call(_a, index$1); }, role: "radio", "aria-checked": this.currentSliderIndex === index$1 ? 'true' : 'false', tabindex: "0" }, index.h("img", { src: src, alt: wp.i18n.sprintf(wp.i18n.__('Product image number %d, %s', 'sc-image-slider'), index$1 + 1, alt), ...(title ? { title } : {}), srcset: srcset, width: width, height: height, sizes: sizes, loading: index$1 > this.thumbnailsPerPage - 1 ? 'lazy' : 'eager' })))))), index.h("button", { disabled: (_c = this.thumbsSwiper) === null || _c === void 0 ? void 0 : _c.isEnd, class: "image-slider__navigation image-slider--is-next", ref: el => (this.next = el) }, index.h("sc-visually-hidden", null, wp.i18n.__('Go to next product slide.', 'surecart')), index.h("sc-icon", { name: "chevron-right", "aria-hidden": "true", "tab-index": "0" }))))));
  }
...
ScImageSlider.style = scImageSliderCss;
