...
const ScProvisionalBanner = class {
  ...
  render() {
    return (index.h("div", { class: { 'sc-banner': true } }, index.h("p", null, wp.i18n.__('Complete your store setup to go live.', 'surecart'), index.h("a", { href: this.claimUrl }, wp.i18n.__('Complete Setup', 'surecart'), " ", index.h("sc-icon", { name: "arrow-right" })))));
  }
};
