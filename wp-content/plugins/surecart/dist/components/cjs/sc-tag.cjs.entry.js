...
const ScTag = class {
  ...
  render() {
    ...
    return (index.h(Tag, { part: "base", onClick: () => this.handleClearClick(), class: {
        'tag': true,
        // Types
