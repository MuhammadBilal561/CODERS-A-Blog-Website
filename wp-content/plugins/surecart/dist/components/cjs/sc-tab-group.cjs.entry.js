...
const ScTabGroup = class {
  ...
  render() {
    return (index.h("div", { part: "base", class: {
        'tab-group': true,
      }, onClick: e => this.handleClick(e), onKeyDown: e => this.handleKeyDown(e) }, index.h("div", { class: "tab-group__nav-container", part: "nav" }, index.h("div", { class: "tab-group__nav" }, index.h("div", { part: "tabs", class: "tab-group__tabs", role: "tablist" }, index.h("slot", { onSlotchange: () => this.syncTabsAndPanels(), name: "nav" })))), index.h("div", { part: "body", class: "tab-group__body" }, index.h("slot", { onSlotchange: () => this.syncTabsAndPanels() }))));
  }
