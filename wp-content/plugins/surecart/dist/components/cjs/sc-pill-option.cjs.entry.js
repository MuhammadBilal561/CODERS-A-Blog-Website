...
const ScPillOption = class {
  ...
  render() {
    return (index.h("button", { class: {
      ...
      }, tabindex: "0", role: "radio", "aria-checked": this.isSelected ? 'true' : 'false', "aria-disabled": this.isUnavailable ? 'true' : 'false' }, index.h("slot", null)));
  }
};
ScPillOption.style = scPillOptionCss;
