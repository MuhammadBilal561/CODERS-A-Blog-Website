...
import { a as getHumanDiscount } from './price-178c2e2b.js';
...
const ScCancelDiscount = class {
  ...
  render() {
    ...
    return (h("div", { class: "cancel-discount" }, h("sc-dashboard-module", { heading: title, style: { '--sc-dashboard-module-spacing': '2em' } }, h("span", { slot: "description" }, description), h("sc-flex", { justifyContent: "flex-start" }, h("sc-button", { type: "primary", onClick: () => this.addDiscount() }, button), h("sc-button", { class: "cancel-discount__abort-link", type: "text", onClick: () => this.scCancel.emit() }, cancel_link)), !!this.loading && h("sc-block-ui", { spinner: true }))));
  }
};
