...
const ScSubscriptionVariationConfirm = class {
  ...
  render() {
    var _a, _b;
    return (h("sc-dashboard-module", { heading: this.heading || wp.i18n.__('Enter An Amount', 'surecart'), class: "subscription-switch" }, h("sc-card", null, h("sc-form", { onScSubmit: this.handleSubmit }, h("div", { class: "sc-product-variation-choice-wrap" }, (((_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.variant_options) === null || _b === void 0 ? void 0 : _b.data) || []).map(({ name, values, id }, index) => {
      var _a, _b;
    ...
    })), h("sc-button", { type: "primary", full: true, submit: true, loading: this.busy }, this.buttonText(), " ", h("sc-icon", { name: "arrow-right", slot: "suffix" })))), this.busy && h("sc-block-ui", { style: { zIndex: '9' } })));
  }
};
