        ...
        if ( $loop->have_posts() ) {
            ...
            if ( $settings['grid_skin'] == 'custom_grid' ) {
                ...
                if ( !$grid_template_id ) {
                    ...
                    $output .= '<div' . esc_attr( $dir ) . ' id="lae-portfolio-' . uniqid() . '" class="lae-portfolio lae-grid-container ' . 'lae-' . str_replace( '_', '-', esc_attr( $settings['grid_skin'] ) ) . '">';
                    $template_output = '';
                ...
                $output .= '<div' . esc_attr( $dir ) . ' id="lae-portfolio-' . uniqid() . '" class="lae-portfolio js-isotope lae-' . esc_attr( $settings['layout_mode'] ) . ' lae-grid-container ' . 'lae-' . str_replace( '_', '-', esc_attr( $settings['grid_skin'] ) ) . lae_get_grid_classes( $settings ) . '" data-isotope-options=\'{ "itemSelector": ".lae-portfolio-item", "layoutMode": "' . esc_attr( $settings['layout_mode'] ) . '", "originLeft": ' . esc_attr( ( !is_rtl() ? 'true' : 'false' ) ) . '}\'>';
